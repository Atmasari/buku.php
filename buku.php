...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top">
            <a href="#">
                <img src="buku3.png" width="150" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="menu">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="proses_login_admin.php?logout=true">Logout</a>
                </li class="nav-item">
                  <a class="nav-link" href="tampilan_customer.php">Customer</a>
                <li>
                </li>
              </ul>
            </div>
    ...
    <div class="container">
                        ...
                        <?php foreach ($query as $buku): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="proses_buku.php?hapus=true&kode_buku=<?php echo$buku["kode_buku"];?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini')">
            ...
            <button data-toggle="modal" data-target="#modal_buku" type="button" class="btn btn-sm btn-dark" onclick="Add()">Tambah Data</button>
                </div>
            </div>
        <!-- end card -->
        <!-- form modal -->
